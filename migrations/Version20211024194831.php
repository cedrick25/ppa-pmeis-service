...
final class Version20211024194831 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE client_sessions (
                    client_session_id INT AUTO_INCREMENT NOT NULL, 
        ...
        $this->addSql('CREATE TABLE clients (
                    ...
                    offense_category enum(\'DO\', \'NDO\'), 
                    field_office_id INT DEFAULT NULL, 
                    is_senior_citizen TINYINT(1) NOT NULL, 
                    is_pwd TINYINT(1) NOT NULL, 
                    supervision_start DATE NOT NULL, 
                    supervision_end DATE NOT NULL, 
                    client_remarks_id INT DEFAULT NULL, 
                    created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', 
                    updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', 
                    deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', 
                    PRIMARY KEY(client_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
