...
final class Version20211022183517 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sessions (session_id INT AUTO_INCREMENT NOT NULL, remarks_id INT NOT NULL, trees_planted INT DEFAULT NULL, field_office_id INT NOT NULL, phase_id INT NOT NULL, batch VARCHAR(255) NOT NULL, session_activity_id INT NOT NULL, treatment_category_id INT NOT NULL, date DATE NOT NULL, venue_id INT NOT NULL, period enum(\'AM\', \'PM\'), fsg INT NOT NULL, li_lo enum(\'LI\', \'LO\'), created_by INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(session_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
