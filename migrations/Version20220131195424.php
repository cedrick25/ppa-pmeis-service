...
final class Version20220131195424 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE volunteer_operations (
                        volunteer_operation_id INT AUTO_INCREMENT NOT NULL, 
                        volunteer_id INT NOT NULL, 
                        status enum(\'APPOINTED\', \'REAPPOINTED\',\'DROPPED\'), 
                        date DATE NOT NULL, 
                        reason VARCHAR(255) DEFAULT NULL, 
                        date_endorsed DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', 
                        dropped_by INT NOT NULL, 
                        PRIMARY KEY(volunteer_operation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE volunteer CHANGE domestic_partner domestic_partner VARCHAR(255) DEFAULT NULL');
