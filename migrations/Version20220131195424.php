...
final class Version20220131195424 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE volunteer_id (id_no INT AUTO_INCREMENT NOT NULL, volunteer_id INT NOT NULL, admin_name VARCHAR(255) NOT NULL, PRIMARY KEY(id_no)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
