...
final class Version20211103175853 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO field_offices (name, region_id ,created_at) VALUES 
            ...
            ('Talisay City Parole And Probation Office', 11, '{$currentDate}'),
            ('Regional Office - Region VII', 11, '{$currentDate}'),
            ...
            ('Regional Office - Region VIII', 12, '{$currentDate}'),
            ...
            ('Northern Samar Parole And Probation Office No. 1', 12, '{$currentDate}'),
            ('Northern Samar Parole And Probation Office No. 2', 12, '{$currentDate}'),
            ('Samar Parole And Probation Office', 12, '{$currentDate}'),
            ('Southern Leyte Parole And Probation Office', 12, '{$currentDate}'),
            ('Northern Samar Parole And Probation Office', 12, '{$currentDate}'),

            ('Regional Office - Region IX', 13, '{$currentDate}'),
            ...
            ('Zamboanga Del Sur Parole And Probation Office', 13, '{$currentDate}'),
            ...
            ('Regional Office - Region X', 14, '{$currentDate}'),
            ...
            ('Regional Office - Region XIII', 15, '{$currentDate}'),
            ...
            ('Surigao Del Norte Parole and Probation Office', 15, '{$currentDate}'),
            ...
            ('Regional Office - Region XI', 16, '{$currentDate}'),
            ...
            ('Samal City Parole And Probation Office', 16, '{$currentDate}'),
            ...
            ('Davao De Oro Parole And Probation Office', 16, '{$currentDate}'),
            ('Davao Del Sur Parole And Probation Office', 16, '{$currentDate}'),
            ('Davao Del Sur Parole And Probation Office No. 2', 16, '{$currentDate}'),
            ('Davao Oriental Parole And Probation Office', 16, '{$currentDate}'),
            ('Island Garden City Of Samal Parole And Probation Office', 16, '{$currentDate}'),
            ...
            ('Regional Office - Region XII', 17, '{$currentDate}'),
            ('Cotabato City Parole And Probation Office', 17, '{$currentDate}'),
            ('General Santos City Parole And Probation Office', 17, '{$currentDate}'),
            ('Kidapawan City Parole And Probation Office', 17, '{$currentDate}'),
            ('Koronadal City Parole And Probation Office', 17, '{$currentDate}'),
            ('Marawi City Parole And Probation Office', 17, '{$currentDate}'),
            ('Tacurong City Parole And Probation Office', 17, '{$currentDate}'),
            ('Lanao Del Sur Parole And Probation Office', 17, '{$currentDate}'),
            ('Maguindanao Parole And Probation Office', 17, '{$currentDate}'),
            ('North Cotabato Parole And Probation Office', 17, '{$currentDate}'),
            ('Sarangani Parole And Probation Office', 17, '{$currentDate}'),
            ('South Cotabato Parole And Probation Office', 17, '{$currentDate}'),
            ('Sultan Kudarat Parole And Probation Office', 17, '{$currentDate}'),
            ('Cotabato Province Parole And Probation Office', 17, '{$currentDate}');
        ");
    }
