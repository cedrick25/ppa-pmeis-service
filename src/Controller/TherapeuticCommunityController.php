...
class TherapeuticCommunityController extends AbstractController
{
    ...
    {
        return $this->json($this->sessionService->getRegionalTC7(
            (int) $request->get("quarterId"),
            (int) $request->get("regionId")
        ));
    }
    ...
    /**
     * @Route("/session/national-tca7/full/{quarterId}", methods={"GET"})
     */
    public function getNationalTC7(Request $request): Response
    {
        return $this->json($this->sessionService->getNationalTC7((int) $request->get("quarterId")));
    }
    ...
    /**
     * @Route("/client/list/{fieldOfficeId}/{clientType}", methods={"GET"})
     */
    public function getAllByFieldOffice(Request $request): Response
    {
        return $this->json($this->clientService->getAllByFieldOffice(
            (int) $request->get("fieldOfficeId"),
            (int) $request->get("clientType")
        ));
    }
...
//        return $this->json($this->clientSessionService->getById($request->get("query")));
    ...
    /**
     * @Route("/volunteer/database/list/by/{regionId}/{fieldOfficeId}", methods={"GET"})
     */
