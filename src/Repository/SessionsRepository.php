    ...
    public function duplicate(int $id): string
    {
        ...
        $sql = "INSERT INTO sessions 
                    (trees_planted, field_office_id, phase_id, batch, session_activity_id, treatment_category_id, date, 
                     venue_id, period, li_lo, is_community_service, is_tree_planting, is_cooperative_self_help, is_cooperative_self_help_activities, activity_detail, created_by, created_at, updated_at, deleted_at)
