...
class TableIA1SummaryFormRegional implements Form
{
    private const TABLE_NAME = "TableIA1SummaryFormRegional";
    ...
    private function prepare(): Spreadsheet
    {
        ...
        $textAndCoordinates = [
            'E1' => 'REGIONAL OFFICE IQPR CONSOLIDATION FORM - PPA-PLD-FR-002',
    ...
    private function getData(array $data): array
    {
        ...
        foreach ($fieldOffices as $fieldOffice) {
            $treatmentCategoryTotal = $treatmentCategoryTotals[$fieldOffice->getFieldOfficeId()] ?? 0;
            $clientFrequency = $clientSessionsData['client_frequency'][$fieldOffice->getFieldOfficeId()] ?? 0;
            ...
            $data[$fieldOffice->getName()] = [
                ...
                'client_frequency_active_supervision' => $clientFrequency['active_supervision'] ?? 0,
                'client_frequency_others' => $clientFrequency['others'] ?? 0,
    ...
    private function plotContinuationHeader(Spreadsheet $spreadsheet): Spreadsheet
    {
        ...
        $textAndCoordinates = [
            'A' . $this->lastFilledOutCellY => "FIELD OFFICES",
            ...
            'H' . $this->lastFilledOutCellY => "Total Number of Community and Other Related Activities",
            ...
            'F' . $twoRowLastFilledOutCellY => "Number of Tree Planting and Other Related Activities",
