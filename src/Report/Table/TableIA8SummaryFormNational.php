...
class TableIA8SummaryFormNational implements Form
{
    private const TABLE_NAME = "TableIA8SummaryFormNational";
    ...
    private function prepare(): Spreadsheet
    {
        ...
        $textAndCoordinates = [
            'S1' => 'AGENCY IQPR CONSOLIDATION FORM - PPA-PLD-FR-001',
            'A3' => 'IQPR SUMMARY FORM',
            'A4' => $this->quarter->getName() . ' QTR, ' . $this->quarter->getYear(),
            'A7' => "Table I.A.8 NUMBER OF OTHERS CLIENT'S INVOLVEMENT BY PHASE",
            'A8' => 'REGIONAL OFFICES',
