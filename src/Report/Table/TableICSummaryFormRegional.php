...
class TableICSummaryFormRegional implements Form
{
    ...
    public function header(): Spreadsheet
    {
        ...
        $spreadsheet->getActiveSheet()->getStyle('A5:O9')
    ...
    private function prepare(): Spreadsheet
    {
        ...
        $mergesCoordinates = [];
        $boldCoordinates = ['A5:O8'];
        $verticalAlignedCoordinates = ['A5:O8' => 'center'];
        ...
        $spreadsheet->getActiveSheet()->getStyle('A5:O8')->getAlignment()->setWrapText(true);
        $spreadsheet->getActiveSheet()->getStyle('B8:O8')->getFont()->getColor()->setARGB(Color::COLOR_RED);
        $spreadsheet->getActiveSheet()->getRowDimension(5)->setRowHeight(10);
        $spreadsheet->getActiveSheet()->getStyle('A5:O10')->getBorders()->getAllBorders()
            ->setBorderStyle(Border::BORDER_THIN);
        $spreadsheet->getActiveSheet()->getStyle('A8:O8')
