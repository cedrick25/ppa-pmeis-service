...
class TCIA4 implements Form
{
    private const TABLE_NAME = "TCIA4";
    ...
    public function body(): Spreadsheet
    {
        ...
        $spreadsheet->getActiveSheet()->getStyle('C10:AF' . $this->lastFilledOutCellY)->getAlignment()->setHorizontal('center');
    ...
    private function prepare(): Spreadsheet
    {
        ...
        $adjustedColumnWidthCoordinates = [
            'A' => 3, 'B' => 20, 'C' => 3, 'D' => 3, 'E' => 3, 'F' => 3, 'G' => 10, 'J' => 10, 'K' => 10, 'AF' => 25
        ];
